...
export interface ItemsEntryImputTextStateBlockProps {
...
export default function ItemsEntryImputTextStateBlock(props: ItemsEntryImputTextStateBlockProps) {
    ...
    return (
        <div className="flex flex-col items-start justify-center gap-y-1.5 lg:gap-y-3">
            ...
            <input
                ...
                placeholder:text-[rgba(333,333,333,0.2)] pointer-events-none`}
                type="text"   
