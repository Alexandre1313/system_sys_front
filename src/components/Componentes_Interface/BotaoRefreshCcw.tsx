...
interface BotaoRefreshCcwProps {
...
export default function  BotaoRefreshCcw(props:  BotaoRefreshCcwProps) {
    ...
    return (
        ...
        >
            <RefreshCcw className={"animate-rotate"} size={props.iconSize} color={arrowColor} strokeWidth={strokeWidth}/> {props.stringButtton}
        </button>
    )
}
