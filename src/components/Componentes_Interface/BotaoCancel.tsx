...
export default function BotaoCancel(props: BotaoCancelProps) {
    ...
    return (
        <button
            ...
            className={`px-4 py-4 ${bgColor} ${textColor} font-medium rounded-md flex text-[13px] w-[150px]
            items-center justify-center gap-x-3 ${bgHoverColor}
            ${bgHoverColor} transition duration-500`}
        >
            <Slash className="" size={props.iconSize} color={arrowColor} strokeWidth={strokeWidth}/> {props.stringButtton}
        </button>
    )
}
