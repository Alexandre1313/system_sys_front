...
export default function  BotaoPrinter(props:  BotaoPrinterProps) {
    ...
    return (
        ...
        >
            <Printer className={""} size={props.iconSize} color={arrowColor} strokeWidth={strokeWidth}/> {props.stringButtton}
        </button>
    )
}
