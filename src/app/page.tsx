        ...
        <main className="flex flex-col gap-2 lg:gap-3 row-start-2 items-center sm:items-center justify-center">
          ...
          <div className="flex gap-2 lg:gap-3 items-center flex-row flex-wrap justify-center">
            <Link href={'/projetos'} legacyBehavior>
              <a
                className={`rounded-md border border-solid border-white/[.08] dark:border-white/[.145] 
                           transition-colors flex items-center justify-center hover:bg-[#1a1a1a]
                         dark:hover:bg-[#1a1a1a] hover:border-transparent text-[9px] lg:text-[13px]
                           h-7 lg:h-8 px-3 lg:px-5 lg:min-w-40 min-w-[130px]
                           bg-gradient-to-r from-[#0d4127] to-transparent text-green-400`}
                href=""
                target=""
